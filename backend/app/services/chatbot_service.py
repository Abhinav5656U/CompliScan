...
class ChatbotService:
    def __init__(self):
        """Initialize Gemini API for chatbot"""
...
वर्तमान संदर्भ: उपयोगकर्ता ने अभी-अभी एक उत्पाद लेबल स्कैन किया हो सकता है।"""
    ...
    def chat(self, user_message, language='en', conversation_history=None, scan_context=None):
        ...
        Args:
            ...
            scan_context: Optional scan result context for better responses
        
        Returns:
            dict: {
                'response': str,
                'language': str,
                'intent': str  # 'question', 'complaint', 'general'
            }
        """
        try:
    ...
    def summarize_scan_result(self, scan_data, language='en'):
        ...
        Args:
            scan_data: Scan result from your validation service
            language: Target language
        
        Returns:
            str: Human-friendly summary
        """
        try:
...
Do NOT use bullet points. Write naturally like you're explaining to a friend."""
    ...
    def generate_complaint_template(self, scan_data, user_details, language='en'):
        ...
        Args:
            scan_data: Scan result with violations
            user_details: Dict with shop_name, address, user_phone
            language: Target language
